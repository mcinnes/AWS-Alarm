...
function getWeatherString(){
    ...
    //echo $wData['weather'][0]['description'];
    $weatherString = 'The weather today will be '.$wData['weather'][0]['description'].'. The high will be '.$wData['main']['temp_max'].' with a low of '.$wData['main']['temp_min'].'.';
